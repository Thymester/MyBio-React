  ...
  return (
    <div className="resume-section" id="resume">
      ...
      <div className="resume-container">
        ...
        <div className="resume-entry">
            <h3>Commercial Truck Driver - Veriha Trucking, Inc.</h3>
            <p>Marinette, Wisconsin - 04/2023 - 06/2023</p>
            <ul>
                <li>Assure truck is up to DOT standards via a Pre-Trip inspection</li>
                <li>Manage my clocks and trip plan to assure a on-time and safe delivery</li>
                <li>Maintain a professional appearance and approach at shippers and receivers</li>
            </ul>
        </div>
        <div className="resume-entry">
            <h3>Commercial Truck Driver - Werner Enterprises</h3>
            <p>Omaga, Nebraska - 02/2023 - 04/2023</p>
            <ul>
            <li>Assure truck is up to DOT standards via a Pre-Trip inspection</li>
                <li>Manage my clocks and trip plan to assure a on-time and safe delivery</li>
                <li>Maintain a professional appearance and approach at shippers and receivers</li>
        ...
        <div className="resume-entry">
            ...
            <ul>
                ...
                <li>Manage all the scheduling and assure everything is produced and shipped on time</li>
        ...
        <div className="resume-entry">
            ...
            <ul>
                ...
                <li>Write detailed write ups of my findings in a technical and concise way</li>
                <li>Interact with customers and assure changes and implementations are working accordingly</li>
            </ul>
                </div>
            </div>
        </div>
